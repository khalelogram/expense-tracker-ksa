...
$ret=mysqli_query($db,"SELECT year(expense_date) as rptyear,SUM(expense_cost) as totalyear FROM userexpense  where (expense_date BETWEEN '$fdate' and '$tdate') && (user_id='$userid') group by year(expense_date)");
$cnt=1;
